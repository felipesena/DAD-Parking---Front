export const CLIENTE_URL = process.env.VUE_APP_SERVER_HOST + "/api/cliente";
...
export const TARIFA_URL = process.env.VUE_APP_SERVER_HOST + "/api/tarifa";
export const VAGA_URL = process.env.VUE_APP_SERVER_HOST + "/api/vaga";
export const VINCULO_URL = process.env.VUE_APP_SERVER_HOST + "/api/vinculo";